...
# installed.
TCL_PREFIX='C:/END_TO_END_ML/env\Library'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='C:/END_TO_END_ML/env\Library\bin'
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='C:/END_TO_END_ML/env\Library\lib\tcl86t.lib'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-IC:/END_TO_END_ML/env\Library\include'
...
TCL_PACKAGE_PATH='C:/END_TO_END_ML/env\Library\lib'
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-LC:/END_TO_END_ML/env\Library\lib tclstub86.lib'
...
TCL_STUB_LIB_PATH='C:/END_TO_END_ML/env\Library\lib\tclstub86.lib'
